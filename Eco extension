...
(function () {
  ...
  mainMenu.append(
    ...
    collabBtn,
    climateBtn,
    btn("Calendar", () => alert("Calendar coming soon 🌱"))
  );
  ...
  /* ---------------- LEVEL SYSTEM ---------------- */
  const levels = [
    { min: 0, icon: "⚠️", name: "Beginner", text: "You are starting your eco journey." },
    { min: 100, icon: "🌱", name: "Eco Starter", text: "Good habits are growing." },
    { min: 300, icon: "🌿", name: "Green Helper", text: "You actively help the planet." },
  ...
  const dailyContributions = [
    { name: "Recycling everything", points: 10 },
    { name: "Using public transport", points: 15 },
    { name: "Not using AI", points: 15 },
    { name: "Avoiding single-use plastics", points: 25 },
    { name: "Recycling cooking oil", points: 15 },
    { name: "Buying local produce", points: 10 },
    { name: "Saving water", points: 10 },
    { name: "Reducing meat consumption", points: 25 },
    { name: "Using reusable bags", points: 15 },
    { name: "Not using your car", points: 20 },
    { name: "Buying second-hand products", points: 20 },
    { name: "Spending 1 or 2 minutes in the shower", points: 15 },
    { name: "Buying eco-friendly food and produce", points: 20 },
    { name: "Spreading this extension", points: 10 },
    { name: "Using energy-efficient lighting", points: 10 },
  ...
  const donateBtn=btn("Donate",()=>alert("Donation system coming soon 🌍"));
...
document.addEventListener("keydown", (e) => {
    if (e.key === "ç") {  // detecta la tecla ç
        ...
        [mainMenu, natureMenu, userMenu, collabMenu, climateMenu].forEach(menu => {
            menu.style.display = "none"; // ocultar siempre los menús al esconder
        });
    }
});
